...
<div class="w-full py-8 px-4 sm:px-6 lg:px-8">
    ...
    <div class="w-full bg-zinc-900 rounded-xl shadow-2xl overflow-hidden p-6 border border-zinc-800" style="position: relative; background: linear-gradient(135deg, #18181b 0%, #27272a 100%); backdrop-filter: blur(10px);">
        ...
        <h1 class="text-2xl font-bold text-white mb-6" data-flux-component="heading" style="background: linear-gradient(90deg, #60a5fa 0%, #a78bfa 100%); -webkit-background-clip: text; -webkit-text-fill-color: transparent; background-clip: text;">
            Registrar Nueva Compra
        </h1>

        <form action="{{ route('admin.compra.store') }}" method="POST" class="space-y-6">
            @csrf
            ...
            <div style="animation: fade-in-up 0.3s ease-out 0.3s both;">
                ...
                <input type="number" id="proveedor_id" name="proveedor_id"
            ...
            <div style="animation: fade-in-up 0.3s ease-out 0.7s both;">
                <label for="igv" class="block text-sm font-medium text-zinc-300 mb-1 field-label">
                    IGV <span class="text-red-500">*</span>
                </label>
            ...
            <div style="animation: fade-in-up 0.3s ease-out 0.9s both;">
                ...
                <select id="estado" name="estado"
                    class="w-full px-4 py-3 bg-zinc-800 border border-zinc-700 rounded-lg
                    text-white focus:ring-2 focus:ring-blue-500" required
                    style="transition: all 0.3s ease; background: rgba(39, 39, 42, 0.5);">
            ...
            {{-- Observaciones --}}
            <div style="animation: fade-in-up 0.3s ease-out 1s both;">
                ...
                <textarea id="observaciones" name="observaciones" rows="3"
                    class="w-full px-4 py-3 bg-zinc-800 border border-zinc-700 rounded-lg
                    text-white placeholder-zinc-500 focus:ring-2 focus:ring-blue-500"
                    placeholder="Ingrese notas adicionales de la compra"
                    style="transition: all 0.3s ease; background: rgba(39, 39, 42, 0.5);"></textarea>
            </div>

            {{-- Separador --}}
            <div class="relative my-8" style="animation: fade-in-up 0.3s ease-out 1.1s both;">
            ...
            {{-- Nota --}}
            <div class="text-sm text-zinc-500 mb-6" style="animation: fade-in-up 0.3s ease-out 1.2s both; padding: 12px; background: rgba(59, 130, 246, 0.05); border-left: 3px solid #3b82f6; border-radius: 4px;">
                Campos marcados con <span class="text-red-500 font-bold">*</span> son obligatorios
            </div>

            {{-- Botón --}}
            <div class="flex justify-end" style="animation: fade-in-up 0.3s ease-out 1.3s both;">
                <button type="submit"
                    class="px-6 py-3 bg-blue-600 text-white font-medium rounded-lg hover:bg-blue-700
                    focus:outline-none focus:ring-2 focus:ring-blue-500 shadow-lg hover:shadow-xl
