<div class="w-full py-8 px-4 sm:px-6 lg:px-8" x-data="clienteTable()">
                        ...
                        <tr>
                            ...
                            <td class="px-4 py-4 text-sm text-right">
                                ...
                                <button
                                    @click="openModal(
                                        {{ $cliente->id }},
                                        '{{ addslashes($cliente->nombres) }}',
                                        '{{ addslashes($cliente->apellidos) }}',
                                        '{{ addslashes($cliente->email ?? '') }}',
                                ...
                                <form id="delete-form-{{ $cliente->id }}"
                                      action="{{ route('admin.cliente.destroy', $cliente->id) }}"
    ...
    <div x-show="isOpen"
        ...
        <div class="flex items-center justify-center min-h-screen px-4 py-6">
            ...
            <div
                x-transition
                class="relative bg-zinc-900 rounded-xl shadow-2xl w-full max-w-2xl 
                ...
                <form :action="'/admin/cliente/' + currentId" method="POST">
                    ...
                    <div class="px-6 py-5 border-b border-zinc-700 flex justify-between items-center">
                        <h3 class="text-xl font-semibold text-white">Editar Cliente</h3>
                    ...
                    <div class="px-6 py-6 space-y-5">
                        ...
                        <div>
                            <label class="text-sm text-zinc-300 mb-1 block">Nombres *</label>
                            <input type="text" x-model="currentNombres" name="nombres"
                                   class="w-full px-4 py-3 bg-zinc-800 border border-zinc-600 
                                          rounded-lg text-white" required>
                        </div>

                        <div>
                            <label class="text-sm text-zinc-300 mb-1 block">Apellidos *</label>
                        ...
                        <div>
                            <label class="text-sm text-zinc-300 mb-1 block">Email</label>
                        ...
                        <div>
                            <label class="text-sm text-zinc-300 mb-1 block">Teléfono</label>
                    ...
                    <div class="px-6 py-4 bg-zinc-800/50 border-t border-zinc-700 text-right">
                        <button type="button" @click="closeModal"
                            class="px-5 py-2.5 text-sm bg-zinc-700 text-zinc-300 rounded-lg">
                            Cancelar
                        </button>

                        <button type="submit"
                            class="px-5 py-2.5 text-sm bg-blue-600 text-white rounded-lg">
                            Guardar Cambios
                        </button>
                    </div>
...
<script>
    ...
    function clienteTable() {
        return {
            ...
            openModal(id, nombres, apellidos, email, telefono) {
                this.currentId = id;
