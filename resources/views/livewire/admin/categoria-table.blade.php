                ...
                <tbody class="divide-y divide-zinc-800">
                    @forelse ($categorias as $categoria)
                        <tr>
                            ...
                            <td class="px-4 py-4 text-sm text-zinc-300">{{ $categoria->nombre }}</td>
                            <td class="px-4 py-4 text-sm text-zinc-300">{{ $categoria->descripcion }}</td>
                            <td class="px-4 py-4 text-sm text-zinc-300">{{ $categoria->estado }}</td>
                            <td class="px-4 py-4 text-sm text-right">
                                ...
                                <form id="delete-form-{{ $categoria->id }}"
                                    action="{{ route('admin.categoria.destroy', $categoria->id) }}" method="POST"
                                    class="hidden">
                                    @csrf
                                    @method('DELETE')
                                </form>
