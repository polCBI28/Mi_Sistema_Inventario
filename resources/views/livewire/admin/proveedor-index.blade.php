    ...
    <div class="w-full bg-zinc-900 rounded-xl shadow-2xl overflow-hidden p-6 border border-zinc-800" style="position: relative; background: linear-gradient(135deg, #18181b 0%, #27272a 100%); backdrop-filter: blur(10px);">
        ...
        <form action="{{ route('admin.proveedor.store') }}" method="POST" class="space-y-6">
            ...
            <div style="animation: fade-in-up 0.3s ease-out 0.1s both;">
                <label for="ruc" class="block text-sm font-medium text-zinc-300 mb-1 field-label">
                ...
                <input type="text" id="ruc" name="ruc"
                    ...
                    placeholder="Ej: 20481234567" required
            ...
            <div style="animation: fade-in-up 0.3s ease-out 0.2s both;">
                <label for="razon_social" class="block text-sm font-medium text-zinc-300 mb-1 field-label">
                    Razón Social <span class="text-red-500">*</span>
                </label>
                <input type="text" id="razon_social" name="razon_social"
                    class="w-full px-4 py-3 bg-zinc-800 border border-zinc-700 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-white placeholder-zinc-500"
                    placeholder="Ej: Proveedora ABC S.A." required
                    style="transition: all 0.3s ease; background: rgba(39, 39, 42, 0.5);">
                @error('razon_social')
                    <p class="mt-1 text-sm text-red-500 font-medium">{{ $message }}</p>
                @enderror
            ...
            <div style="animation: fade-in-up 0.3s ease-out 0.3s both;">
                <label for="direccion" class="block text-sm font-medium text-zinc-300 mb-1 field-label">
                    Dirección
                </label>
            ...
            <div style="animation: fade-in-up 0.3s ease-out 0.4s both;">
                <label for="telefono" class="block text-sm font-medium text-zinc-300 mb-1 field-label">
                    Teléfono
                </label>
            ...
            <div style="animation: fade-in-up 0.3s ease-out 0.5s both;">
                <label for="email" class="block text-sm font-medium text-zinc-300 mb-1 field-label">
                    Correo Electrónico
                </label>
            ...
            <div class="relative my-8" style="animation: fade-in-up 0.3s ease-out 0.7s both;">
                <div class="absolute inset-0 flex items-center">
                    <div class="w-full divider-gradient"></div>
                </div>
            </div>

            <div class="text-sm text-zinc-500 mb-6" style="animation: fade-in-up 0.3s ease-out 0.8s both; padding: 12px; background: rgba(59, 130, 246, 0.05); border-left: 3px solid #3b82f6; border-radius: 4px;">
                Campos marcados con <span class="text-red-500 font-bold">*</span> son obligatorios
            </div>

            <!-- Botón -->
            <div class="flex justify-end" style="animation: fade-in-up 0.3s ease-out 0.9s both;">
                <button type="submit"
